<template>
  <b-table
    ...
    <b-table-column field="PB 25" label="PB 25" sortable :custom-sort="byPB25"/>
  </b-table>
</template>
<script>
  import {byStartTime, byPB25} from '../sort'
  ...
  export default {
    ...
    computed: {
      results () {
        return this.$store.getters.getResultsSortedBy('PB 25')
      }
    }
  }
</script>
