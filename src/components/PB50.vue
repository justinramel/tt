<template>
  <b-table
    ...
    <b-table-column field="PB 50" label="PB 50" sortable :custom-sort="byPB50"/>
  </b-table>
</template>
<script>
  import {byStartTime, byPB50} from '../sort'
  ...
  export default {
    ...
    computed: {
      results () {
        return this.$store.getters.getResultsSortedBy('PB 50')
      }
    }
  }
</script>
