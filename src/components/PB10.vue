<template>
  <b-table
    ...
    <b-table-column field="PB 10" label="PB 10" sortable :custom-sort="byPB10"/>
  </b-table>
</template>
<script>
  import {byStartTime, byPB10} from '../sort'
  ...
  export default {
    ...
    computed: {
      results () {
        return this.$store.getters.getResultsSortedBy('PB 10')
      }
    }
  }
</script>
